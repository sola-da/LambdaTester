    ...
    function getCallbacks(baseObjectName, functionName) {
        ...
        for (let i = 0; i < minedDataFiles.length; i++) {
            ...
            for (let j = 0; j < minedData.length; j++) {
                ...
                if (typeof baseObjectName !== "undefined" && callbackEntry.receiverBase !== baseObjectName)
                    continue;
                if (typeof functionName !== "undefined" && callbackEntry.receiverCallee !== functionName)
                    continue;
