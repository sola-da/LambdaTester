...
var argument7 = function() {
 callbackArguments.push(arguments) 
 return {"Å\u000b/":false,"R+°\u001b®2w":0,"ßä":true,"úÜ":4.611473930923116,"¢J«":"tU"}; };
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/reduce/reduceQC/test759.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)