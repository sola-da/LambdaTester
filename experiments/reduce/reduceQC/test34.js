...
var argument6 = function() {
 callbackArguments.push(arguments) 
 return [0,null,[],-7.882498818286736,-13,6.358007001349819,null]; };
var argument7 = r_2;
var argument8 = true;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/reduce/reduceQC/test34.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)