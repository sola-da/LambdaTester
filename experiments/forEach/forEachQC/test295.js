...
var argument1 = function() {
 ...
 return [0.019789635330837996,0,false]; };
var argument2 = 5.659809783669548e+306;
var argument3 = function() {
 callbackArguments.push(arguments) 
 return -4.61672829737354; };
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachQC/test295.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)