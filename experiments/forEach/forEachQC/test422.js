...
var argument6 = function() {
 callbackArguments.push(arguments) 
 return [null,false,true,-2,false,false,null]; };
var argument7 = r_2;
var argument8 = "1";
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachQC/test422.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)