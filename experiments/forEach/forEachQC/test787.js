...
var argument2 = function() {
 callbackArguments.push(arguments) 
 return [{},null,null,false,3,true,true,-26.717983762842092]; };
var argument3 = null;
var argument4 = true;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachQC/test787.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)