...
var argument4 = function() {
 callbackArguments.push(arguments) 
 return {"X>-\rµå}":0,"¤þ\u0017ªS":0,"»\u0007Q`\u0001ak":"qÃ","ìÔDõãa":false}; };
var argument5 = "9P";
var argument6 = null;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachQC/test364.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)