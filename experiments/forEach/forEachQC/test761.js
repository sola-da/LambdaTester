...
var argument7 = function() {
 callbackArguments.push(arguments) 
 return [0,[],3.0737647349350796,-4,[],-7,[0],true]; };
var argument8 = r_0;
var argument9 = r_0;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachQC/test761.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)