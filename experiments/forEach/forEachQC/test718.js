...
var argument1 = function() {
 ...
 return [true,0,null,2.2650306407011964]; };
var argument2 = 1.5960525826387235e+307;
var argument3 = function() {
 callbackArguments.push(arguments) 
 return 71.68676025961958; };
var argument4 = false;
var argument5 = null;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachQC/test718.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)