...
var argument7 = function() {
 callbackArguments.push(arguments) 
 return {"ú":true,"\nB .|ã\u000f\u0005":0,"Ìf½úK\u0004z":-2,"\ta":[],"Ê!aJ1;ø¼":false,"éb\fkI":false,"ë#k":true}; };
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachQC/test13.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)