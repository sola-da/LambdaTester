...
callbackArguments.push(JSON.stringify(arguments))
base_2[4] = {"2O":"","":":","1.3429398230843351e+308":2.7422155992360478e+306}
return a/b+c
};
var argument8 = function callback(a,b,c) { 
callbackArguments.push(JSON.stringify(arguments))
base_3[9] = [-100,714,213,-1,460,403]
base_3[2] = ""
return a+b+c
};
var argument9 = false;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachGen/test33.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)