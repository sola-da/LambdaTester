...
base_0[0][4] = 1.5454972654675404e+308
return a-b*c
};
...
base_1[6] = "_"
argument6 = ["(]$",">"]
base_1[1][2] = ["W",823,"4",49,714,122,"oQ","=","T","X{"]
return a*b*c
};
var argument5 = null;
var argument6 = function callback(a,b,c) { 
callbackArguments.push(JSON.stringify(arguments))
argument7[3.0481490052276395e+306] = false
return a/b-c
};
...
callbackArguments.push(JSON.stringify(arguments))
base_3[1][2] = true
argument10[2] = 5.372445529753765e+307
argument10 = null
return a*b/c
};
var argument10 = "r";
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachGen/test304.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)