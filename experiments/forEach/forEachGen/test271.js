...
callbackArguments.push(JSON.stringify(arguments))
base_3[4] = 9.27871059281697e+307
argument7[2] = [893,705,823]
argument8[3] = [")","E)"]
return a-b+c
};
var argument7 = null;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachGen/test271.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)