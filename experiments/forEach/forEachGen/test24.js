...
argument2[2] = {"627":"","":1.6554953615680134e+308,"2'|":-1}
base_0[8] = ""
base_0[3] = [157,25,714]
return a+b*c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachGen/test24.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)