...
argument2[2][783] = 607
base_0[8] = [783,893,893,0,969,714,843,82,460]
return a+b-c
};
var argument2 = 595;
var argument3 = 403;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachGen/test140.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)