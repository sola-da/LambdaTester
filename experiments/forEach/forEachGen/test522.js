...
callbackArguments.push(JSON.stringify(arguments))
argument7[1] = [-1,714,122,403,823,1.7976931348623157e+308,82]
return a+b-c
};
var argument7 = r_0;
var argument8 = function callback(a,b,c) { 
callbackArguments.push(JSON.stringify(arguments))
argument10[5] = 8.973227643839851e+306
return a-b/c
};
var argument9 = null;
var argument10 = r_3;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachGen/test522.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)