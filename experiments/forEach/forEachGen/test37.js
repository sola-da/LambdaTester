...
callbackArguments.push(JSON.stringify(arguments))
argument6[1] = 2.4831905266755273e+307
return a-b/c
};
...
callbackArguments.push(JSON.stringify(arguments))
base_2[6] = true
argument7[6] = 7.42385357645298e+307
argument7[2] = [122,893,-100]
return a-b/c
};
var argument7 = "";
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachGen/test37.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)