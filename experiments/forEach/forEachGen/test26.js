...
base_2[2] = true
argument5 = "9"
base_2['length'] = 7.403510193902522e+307
return a*b/c
};
...
callbackArguments.push(JSON.stringify(arguments))
base_3[0] = [0,-100,607,705,705,823,607]
return a/b+c
};
var argument8 = null;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachGen/test26.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)