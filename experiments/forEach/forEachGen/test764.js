...
callbackArguments.push(JSON.stringify(arguments))
argument6[2] = false
argument5['wIs'] = 1.3299353448153026e+308
return a+b*c
};
var argument5 = true;
...
callbackArguments.push(JSON.stringify(arguments))
argument7['?'] = null
argument7[4] = [893,-1,714,59,126,1.7976931348623157e+308]
return a/b+c
};
...
callbackArguments.push(JSON.stringify(arguments))
argument9[157] = 4.503561323495315e+307
argument8['1SHF1'] = ""
return a*b*c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachGen/test764.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)