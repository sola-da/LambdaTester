...
argument2[4.224481734419934e+307] = "d*O"
return a+b/c
};
...
base_3[2] = false
argument8[8] = 6.929797441863967e+307
return a-b/c
};
var argument8 = null;
var argument9 = r_2;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachGen/test539.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)