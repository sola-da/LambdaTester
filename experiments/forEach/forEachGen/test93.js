...
callbackArguments.push(JSON.stringify(arguments))
base_1[3][0] = {"242":"","403":"","893":"","969":"","":"no6 ","M^":655,"1.0156648733444519e+308":"2","P":714}
argument3['1SHF1'] = {"":"J","b6F":"","1.1269507788457876e+308":"","V":1.3805680913927273e+308}
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachGen/test93.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)