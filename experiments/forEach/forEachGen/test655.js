...
base_0[0][823] = {"":7.491743824885326e+306}
base_0[9] = 655
return a+b/c
};
var argument2 = r_0;
...
base_3[5] = 843
argument8[5] = null
argument6[2] = [122,49,"_&4U","IAM","5","%",403]
return a/b*c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachGen/test655.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)