...
callbackArguments.push(JSON.stringify(arguments))
argument4[1.7976931348623157e+308] = 242
return a*b-c
};
var argument3 = r_0;
var argument4 = r_1;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachGen/test428.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)