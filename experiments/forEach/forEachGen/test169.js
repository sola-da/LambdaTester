...
callbackArguments.push(JSON.stringify(arguments))
argument5[126] = 655
argument6[0] = 8.219784783049552e+307
argument6[0] = false
return a/b/c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachGen/test169.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)