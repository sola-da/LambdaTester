...
callbackArguments.push(JSON.stringify(arguments))
base_3[1][2] = null
base_3[3] = [122,82,59,618,595,627,59]
return a*b/c
};
var argument11 = r_3;
var base_0 = ["Ps","Y","|"]
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachGen/test16.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)