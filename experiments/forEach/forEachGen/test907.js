...
argument3 = {"7.565868824273664e+307":7.274165450395838e+306,"VsR":705,"-1":893}
base_0[0][0] = -100
return a-b-c
};
var argument2 = null;
...
callbackArguments.push(JSON.stringify(arguments))
base_2[8] = [627,843,59,82,82,1.7976931348623157e+308,59,242,595,213]
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/forEach/forEachGen/test907.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)