...
callbackArguments.push(JSON.stringify(arguments))
argument3[460] = 8.257032442163062e+306
argument4[126] = {"460":122,"705":-100,"1.116060212984397e+308":403,"":""}
return a/b+c
};
var argument3 = null;
var argument4 = false;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/filter/filterGen/test791.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)