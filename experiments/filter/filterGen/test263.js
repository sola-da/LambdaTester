...
callbackArguments.push(JSON.stringify(arguments))
argument5[4] = [25,627,783,403,705,242,607,126,893,403]
base_1[8][3] = [0,460,126,126,618,403,627,1.7976931348623157e+308,82]
return a+b+c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/filter/filterGen/test263.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)