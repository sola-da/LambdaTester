...
callbackArguments.push(JSON.stringify(arguments))
base_3['filter'] = {"122":-1,"157":714,"783":"76","969":""}
argument11[1] = 1.73793667775054e+307
return a+b-c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/filter/filterGen/test198.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)