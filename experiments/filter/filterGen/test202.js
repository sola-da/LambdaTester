...
callbackArguments.push(JSON.stringify(arguments))
argument6[-1] = {"403":"","655":122,"783":7.342422763890615e+307,"1.758836627906837e+308":122,"":122,"EYR":"K"}
argument7[2] = null
return a+b/c
};
var argument6 = true;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/filter/filterGen/test202.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)