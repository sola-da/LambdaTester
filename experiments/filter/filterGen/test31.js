...
callbackArguments.push(JSON.stringify(arguments))
base_3[9] = {"618":627,"-1":9.981132669994919e+307,"":783}
base_3[5] = true
return a+b+c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/filter/filterGen/test31.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)