...
base_0[6] = {"403":8.429871286056824e+307,"6.511262859542731e+307":1.7976931348623157e+308,"1.283704539492474e+308":8.514729756570929e+307}
return a/b*c
};
...
callbackArguments.push(JSON.stringify(arguments))
argument4[5] = ""
base_1[1][1] = [-100,100,705,242,-100,627,126,157]
argument4[2] = {"618":8.945013729830286e+307,"1.3571928124337112e+308":"p","":126}
return a*b*c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/filter/filterGen/test192.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)