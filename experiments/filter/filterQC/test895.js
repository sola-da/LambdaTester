...
var argument5 = function() {
 callbackArguments.push(arguments) 
 return [true,null,-0.33488122804666354,false]; };
var argument6 = "U5n";
var argument7 = r_2;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/filter/filterQC/test895.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)