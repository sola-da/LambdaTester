...
var argument7 = function() {
 callbackArguments.push(arguments) 
 return [0,-0.018424727060076362,null,2,null,-8,-19.381949507202542,null]; };
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/filter/filterQC/test571.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)