...
var argument1 = function() {
 ...
 return {"\u0005\u001e³Ð":-0.7912382233225694,"(åÕ":false,"G¥U§":1.1660436433670271,"Õ\u0002î;H":false}; };
var argument2 = null;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/filter/filterQC/test389.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)