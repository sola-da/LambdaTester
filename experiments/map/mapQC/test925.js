...
var argument9 = function() {
 callbackArguments.push(arguments) 
 return [null,0.7268115648783162,null]; };
var argument10 = null;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/map/mapQC/test925.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)