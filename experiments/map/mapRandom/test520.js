...
setTimeout(function(){
require("fs").writeFileSync("./experiments/map/mapRandom/test520.json",JSON.stringify({"baseObjects":serialize([base_0]),"returnObjects":serialize([r_0]),"callbackArgs":callbackArguments}))
},300)