...
callbackArguments.push(JSON.stringify(arguments))
argument3[9.869573703797622e+307] = "nt%3"
argument3[49] = ""
argument4[157] = 1.4136036095414704e+307
return a-b+c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/map/mapGen/test389.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)