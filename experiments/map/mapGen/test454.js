...
callbackArguments.push(JSON.stringify(arguments))
base_1[5] = {"5.531751439231227e+307":49,"":""}
argument4[714] = "_"
...
callbackArguments.push(JSON.stringify(arguments))
base_3[2] = {"a":1.2908498570980348e+308,"z+7":1.414936744240706e+308}
argument6 = {"403":49,"618":"","8.381360142835393e+307":"","1.1924850842960547e+308":"","L":1.0436754198034421e+308,"9.78619046815181e+307":0,"@{":49}
return a-b/c
};
var argument7 = r_1;
var argument8 = r_1;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/map/mapGen/test454.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)