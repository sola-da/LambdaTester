...
argument2[403] = "A"
argument2['C'] = [1.7976931348623157e+308,969,627,126,843,242,100,969,122]
argument2[5] = 595
return a*b/c
};
...
callbackArguments.push(JSON.stringify(arguments))
argument5[403] = {"1.4388680220768613e+308":"Im"}
base_1[4] = false
return a*b+c
};
var argument5 = false;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/map/mapGen/test433.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)