...
base_0[5] = "p"
argument3[5] = {"":"","3.0395610780161906e+307":""}
...
base_3[6] = null
base_3[6] = 100
argument11[1.7173047913506838e+308] = 843
return a-b/c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/map/mapGen/test829.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)