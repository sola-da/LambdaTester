...
var argument7 = function() {
 callbackArguments.push(arguments) 
 return {"¦Ð¦":true,"4a\t\u001bïß":true,"9y-":"\u0015","ÌoF¦6û$,":[true],"w\u0004y*\u001cSI":8.251851363965264,"\fÂfù":16}; };
var argument8 = null;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/find/findQC/test76.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)