...
var argument5 = function() {
 callbackArguments.push(arguments) 
 return [true,0,2.2651775614245464,true,-14,[null,true,null],-35.067960189041834,true]; };
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/find/findQC/test533.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)