...
var argument9 = function() {
 callbackArguments.push(arguments) 
 return [0,"l",true,-7.562515718336879,-4,true,false]; };
var argument10 = null;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/find/findQC/test925.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)