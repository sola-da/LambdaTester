...
var argument4 = function() {
 callbackArguments.push(arguments) 
 return [0,false,0.5738037966978737]; };
var argument5 = false;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/find/findQC/test271.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)