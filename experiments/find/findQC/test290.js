...
var argument7 = function() {
 callbackArguments.push(arguments) 
 return [null,0,null,null,null,null,-23.441809236932208]; };
var argument8 = r_2;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/find/findQC/test290.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)