...
callbackArguments.push(JSON.stringify(arguments))
argument4[893] = 3.1454257316548046e+307
base_1[1] = null
base_1[8] = ["e",82,"e",969,714]
return a/b/c
};
var argument5 = r_1;
var argument6 = r_1;
...
callbackArguments.push(JSON.stringify(arguments))
argument9 = null
argument10[1.0500354979187844e+308] = true
return a/b/c
};
var argument10 = null;
var argument11 = null;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/find/findGen/test839.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)