...
callbackArguments.push(JSON.stringify(arguments))
argument7[0] = [242,5e-324,0,655,595,-100,49]
argument7['AO?'] = null
base_2[4] = null
return a*b/c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/find/findGen/test126.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)