...
callbackArguments.push(JSON.stringify(arguments))
argument3[126] = ["{","0No","BE2","6","ex","N",1.7976931348623157e+308]
...
argument5[8] = [618,213,705,655,893,969,82,213,655]
return a+b/c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/find/findGen/test966.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)