...
callbackArguments.push(JSON.stringify(arguments))
argument6[3.377960715099946e+307] = 25
return a-b/c
};
var argument7 = r_1;
...
callbackArguments.push(JSON.stringify(arguments))
argument10[1.399309004356655e+308] = null
argument11['!j'] = 823
argument10['j'] = {"59":"","595":"","969":1.5055689715042052e+308,"":0,"Ld":4.912769922556103e+307,"2.2122544918536986e+307":"","-qjl":1.7825708245709928e+307,"6.109922509922479e+307":157}
return a-b-c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/find/findGen/test258.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)