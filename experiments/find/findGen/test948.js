...
argument3['!j'] = null
argument2[4] = true
base_0[8] = {"242":1.7976931348623157e+308}
return a+b+c
};
...
callbackArguments.push(JSON.stringify(arguments))
argument9[6.447566193969e+307] = {"714":"l?Ax","":"r","$":9.080884272002657e+307,"6.988457462177e+306":6.59815033169415e+307}
argument9[49] = "t"
base_3[0][6] = null
return a-b*c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/find/findGen/test948.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)