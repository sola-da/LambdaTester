...
callbackArguments.push(JSON.stringify(arguments))
argument6[6.949630915607762e+307] = false
argument6[969] = null
return a/b/c
};
var argument5 = "_";
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/find/findGen/test906.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)