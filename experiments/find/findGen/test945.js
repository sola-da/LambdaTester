...
base_0[6] = null
base_0[0][3] = ["%","zmRf","7","%O",">","-","z]y@{","IL"]
return a/b*c
};
var argument2 = function callback(a,b,c) { 
callbackArguments.push(JSON.stringify(arguments))
argument3[6.447566193969e+307] = 82
argument4[4] = {"":126,"C":""}
return a/b+c
};
var argument3 = "";
...
callbackArguments.push(JSON.stringify(arguments))
argument6[6.770908161223588e+307] = null
argument5[1] = {"1.3994077659893325e+308":"","u":"s"}
argument6[7] = null
return a+b/c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/find/findGen/test945.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)