...
callbackArguments.push(arguments)
 return [0,0.6359789465090222,true,null,-11.331494125949643,13.344616091892114,null]; }
;
var argument2 = 893;
var argument3 = false;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/promises/promiseQC/test883.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)