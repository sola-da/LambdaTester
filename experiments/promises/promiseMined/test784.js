...
var argument2 = {"1.4456434069271093e+308":"1H=im","^#&t":""};
var argument3 = {"E":""};
...
var argument6 = true;
var argument7 = [242,627,627,618,969,705,100];
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/promises/promiseMined/test784.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)