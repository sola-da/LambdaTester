...
var argument2 = p1;
var argument3 = function Promise_timeout_rejected(error) {
 callbackArguments.push(arguments) 
...
var argument7 = null;
var argument8 = [714,607,-1,893,25,403];
var base_0 = p1
var r_0= undefined
try {
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/promises/promiseMined/test38.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)