...
var argument2 = function (loginController) {
 callbackArguments.push(arguments) 
...
var r_3= undefined
try {
r_3 = base_3.catch(argument4,argument5,argument6)
}
catch(e) {
r_3= e.message
}
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/promises/promiseMined/test426.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)