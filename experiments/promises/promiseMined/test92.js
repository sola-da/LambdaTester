...
var argument8 = {"zA":";p>","A":"","=V":"11e","1.0400658109989964e+308":""};
var argument9 = true;
var base_0 = p2
var r_0= undefined
try {
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/promises/promiseMined/test92.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)