...
var argument5 = null;
var argument6 = 6.914706889096842e+307;
...
var argument8 = ["0"];
var argument9 = ["r","H+e","O=H",843,705];
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/promises/promiseMined/test675.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)