...
var argument1 = p1;
var argument2 = function getEmail() {
...
var argument5 = [213,"gQ",893,"D",705,"5","0B&1*q",893];
var argument6 = function _thenBypassUnless() {
 callbackArguments.push(arguments) 
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/promises/promiseMined/test436.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)