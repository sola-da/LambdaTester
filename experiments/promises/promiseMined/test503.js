...
var argument6 = function (_el) {
 callbackArguments.push(arguments) 

    el = _el;
};
var argument7 = r_0;
var argument8 = {"1.1970007654248764e+308":5.349925144616473e+307};
var base_0 = p1
var r_0= undefined
try {
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/promises/promiseMined/test503.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)