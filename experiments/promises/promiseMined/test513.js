...
var argument5 = [",",";","`Ug","q{","|xU"];
var argument6 = [-1,-1,49,714,25,460];
var argument7 = function (err) {
 callbackArguments.push(arguments) 

    done();
};
var argument8 = {"25":"","T":"q","":"V!"};
var base_0 = p1
var r_0= undefined
try {
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/promises/promiseMined/test513.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)