...
var argument1 = 3.044210485206433e+307;
var argument2 = function (r) {
 callbackArguments.push(arguments) 

    deferred.reject(r);
};
var argument3 = function checkCharacterCount() {
 callbackArguments.push(arguments) 
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/promises/promiseMined/test938.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)