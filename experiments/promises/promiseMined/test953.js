...
var argument2 = {"607":"*","w":"7n&K","":655,"2f{":655};
var argument3 = p1;
...
var argument5 = p2;
var argument6 = [655,618,607,"KI","#]Y",59,607,-100,"pf"];
var argument7 = function (svg) {
 callbackArguments.push(arguments) 
...
var argument8 = null;
var argument9 = p1;
var argument10 = function (parentReferenceValue) {
 callbackArguments.push(arguments) 
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/promises/promiseMined/test953.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)