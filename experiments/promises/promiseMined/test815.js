...
var argument1 = [595,59,607,460,100,705];
...
var argument5 = function onReject(reason) {
 callbackArguments.push(arguments) 

    reject(reason);
};
var argument6 = 1.4044860404574058e+308;
var argument7 = 6.674328181612027e+307;
var argument8 = function (rendered) {
 callbackArguments.push(arguments) 
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/promises/promiseMined/test815.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)