...
var argument3 = null;
var argument4 = [403,595];
var argument5 = function (builtDriver) {
 callbackArguments.push(arguments) 
...
var argument9 = r_2;
var argument10 = null;
var argument11 = function (content) {
 callbackArguments.push(arguments) 
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/promises/promiseMined/test326.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)