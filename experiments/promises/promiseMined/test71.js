...
var argument4 = p1;
var argument5 = [157,126,893,843,460,627,823];
var argument6 = p1;
...
var argument10 = ["owc3","fi_4SW","qF%","V","u","w","U","9","Ds="];
var base_0 = p1
var r_0= undefined
try {
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/promises/promiseMined/test71.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)