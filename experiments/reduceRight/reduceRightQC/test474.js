...
var argument5 = function() {
 callbackArguments.push(arguments) 
 return [0,null,true,null,true,19.824969848061393]; };
var argument6 = r_2;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/reduceRight/reduceRightQC/test474.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)