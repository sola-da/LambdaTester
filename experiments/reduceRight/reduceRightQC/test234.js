...
var argument3 = function() {
 callbackArguments.push(arguments) 
 return [-0.30065519217480596,"",null,8,"/õZ",11]; };
var argument4 = true;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/reduceRight/reduceRightQC/test234.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)