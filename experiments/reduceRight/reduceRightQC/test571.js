...
var argument1 = function() {
 ...
 return [null,null,1,0,-10,"Â",null,true]; };
var argument2 = null;
var argument3 = ["F","FB","+KT","hK","RJ(","`","5?","f[OGSB"];
var argument4 = function() {
 callbackArguments.push(arguments) 
 return 0.02524128055270136; };
var argument5 = false;
var argument6 = null;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/reduceRight/reduceRightQC/test571.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)