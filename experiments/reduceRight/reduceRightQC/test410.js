...
var argument9 = function() {
 callbackArguments.push(arguments) 
 return [true,true,3,false,null,true]; };
var argument10 = r_2;
var argument11 = r_1;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/reduceRight/reduceRightQC/test410.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)