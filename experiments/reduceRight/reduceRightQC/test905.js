...
var argument1 = function() {
 ...
 return {"Ø\u001eX\t":-0.6846755221475973,"":-0.2756479293867471,"Rë}P«\u0015å6":[]}; };
var argument2 = false;
var argument3 = false;
var argument4 = function() {
 callbackArguments.push(arguments) 
 return -85.24705753177773; };
var argument5 = true;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/reduceRight/reduceRightQC/test905.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)