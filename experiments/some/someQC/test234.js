...
var argument6 = function() {
 callbackArguments.push(arguments) 
 return {"\u000b\u001d":-0.21370242682098572,"Æ\u001f4Ô_":-2.6633793357408146}; };
var argument7 = r_2;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someQC/test234.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)