...
var argument7 = function() {
 callbackArguments.push(arguments) 
 return [null,0.16767600901469004,"L£",[true],"z"]; };
var argument8 = r_2;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someQC/test855.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)