...
var argument1 = function() {
 ...
 return [0,0.039475606617993764,null,2.2238981330108056,8]; };
var argument2 = 595;
var argument3 = false;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someQC/test153.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)