...
callbackArguments.push(JSON.stringify(arguments))
base_3[1]['{X'] = null
base_3[4][8] = 8.482230292105663e+307
return a+b+c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someGen/test859.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)