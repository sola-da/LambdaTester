...
callbackArguments.push(JSON.stringify(arguments))
base_1['length'] = 1.0733132294602367e+308
return a/b+c
};
var argument3 = null;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someGen/test205.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)