...
callbackArguments.push(JSON.stringify(arguments))
argument5[5] = 7.310900488778069e+307
argument5['Y'] = false
argument4[0] = [655,0,655,618,82]
return a-b-c
};
var argument5 = r_0;
var argument6 = null;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someGen/test613.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)