...
base_0[4][7] = 1.4205953642086038e+308
return a-b*c
};
var argument2 = null;
var argument3 = null;
...
callbackArguments.push(JSON.stringify(arguments))
base_1[4][7] = 3.4666455340777e+307
return a/b*c
};
var argument5 = r_0;
...
callbackArguments.push(JSON.stringify(arguments))
argument7 = [595,705,893,126,122,-100,705]
argument8[3][3] = "2@uW"
return a*b-c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someGen/test783.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)