...
argument2['j'] = {"213":595,"714":783,"893":"","":"sz","4.0455515785445895e+307":655,"p1@p":1.2001448625885862e+308,"9.93873512703908e+307":627}
return a+b+c
};
...
callbackArguments.push(JSON.stringify(arguments))
argument5['f!BO'] = [-1,607,126,595,-100,403,655]
return a/b-c
};
var argument5 = function callback(a,b,c) { 
callbackArguments.push(JSON.stringify(arguments))
argument6[0] = {"403":"`","1.743062130644917e+308":714,"p^a":618,"8.702829746791725e+306":"$C","E":1.6010711439388854e+308,"1.7976931348623157e+308":"","6.553717445438271e+307":6.980517987960866e+307,"":607,"_":5e-324}
argument6['_W'] = null
base_2[1][2] = 242
return a/b-c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someGen/test813.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)