...
callbackArguments.push(JSON.stringify(arguments))
base_1[5][0] = ""
argument4['f'] = [783,25,-1,460,607,969,403,-100]
return a-b+c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someGen/test971.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)