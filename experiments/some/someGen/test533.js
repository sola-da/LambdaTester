...
argument2[4] = {"6":"MxYXiP","100":"wM","618":"","893":1.7905031626702353e+308,"":3.48204148050827e+307,"3.3934881235753487e+307":""}
base_0[9] = true
argument2 = ""
return a+b*c
};
...
callbackArguments.push(JSON.stringify(arguments))
base_1[1][8] = [843,126,655,-1,5e-324,607,460,714,242]
return a-b+c
};
var argument4 = false;
var argument5 = r_1;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someGen/test533.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)