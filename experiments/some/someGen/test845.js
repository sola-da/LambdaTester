...
argument2['Y'] = 655
argument3[2] = [5e-324,-100,126,1.7976931348623157e+308,705,25,126,705,-100,823]
return a-b-c
};
...
callbackArguments.push(JSON.stringify(arguments))
argument7['V'] = 3.644831437865407e+307
base_2[3][4] = {"6.423275694364843e+307":""}
argument6[7] = true
return a/b+c
};
var argument6 = null;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someGen/test845.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)