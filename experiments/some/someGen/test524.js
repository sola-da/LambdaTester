...
callbackArguments.push(JSON.stringify(arguments))
argument8['^h'] = {"627":82,"AXB":9.342928399045978e+307,"-100":",)r","":"","1C":"","1.481798058557502e+308":"E)","K[":"","<8":"","1.7555331522355558e+306":""}
argument7[2] = true
argument8[3] = -100
return a+b/c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someGen/test524.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)