...
callbackArguments.push(JSON.stringify(arguments))
base_1['length'] = "_#"
argument6[3] = [655,59,783,59,-100,213,403,595,893]
return a*b/c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someGen/test879.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)