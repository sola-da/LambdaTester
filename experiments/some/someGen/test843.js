...
base_0[5] = "p"
base_0[0][3] = {"":"","3.0395610780161906e+307":""}
...
callbackArguments.push(JSON.stringify(arguments))
argument5['f'] = {"893":"@","1.6935108354991854e+308":25,"1.4640526128022138e+308":1.0369232402692977e+308,"I":"","":"*","#J ":122}
argument5['_W'] = false
return a/b-c
};
var argument5 = null;
...
base_3[6] = null
base_3[6] = 100
argument11[1.5109538778533692e+308] = 843
return a-b/c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someGen/test843.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)