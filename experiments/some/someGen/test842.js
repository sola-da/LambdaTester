...
callbackArguments.push(JSON.stringify(arguments))
argument4[4] = ["1W","P","qTS)","Y","S","TDpN","O1"]
return a/b/c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someGen/test842.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)