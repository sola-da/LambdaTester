...
callbackArguments.push(JSON.stringify(arguments))
base_2[1][0] = {"126":100,"655":4.453773288167034e+307,"893":9.049759773852002e+307,"1.3555749636832502e+308":"3aA","":"Cj","4.894431419864256e+307":"","[e":100,"1.2870770546619427e+308":"","1.3407979130863208e+308":9.44575866993825e+307}
base_2[0] = null
...
callbackArguments.push(JSON.stringify(arguments))
argument11[1] = false
argument10['f!BO'] = 5.904495945954163e+307
return a*b/c
};
var argument10 = r_2;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someGen/test269.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)