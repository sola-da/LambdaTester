...
callbackArguments.push(JSON.stringify(arguments))
argument8[1] = {"783":"","":1.058434765454531e+308,"&":""}
argument8[1] = ""
base_3[1]['{X'] = null
return a*b/c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someGen/test545.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)