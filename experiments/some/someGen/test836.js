...
callbackArguments.push(JSON.stringify(arguments))
argument8['Y'] = {"59":"KX","1.002040230507018e+308":1.1881888464115996e+308,"f-m":969,"":1.611056866022973e+308,"1.3618707999928265e+308":"}"}
base_2[1][2] = [403,618,"]"]
...
callbackArguments.push(JSON.stringify(arguments))
base_3[5][0] = null
argument10[3] = {"460":242,"893":"$1=y:","1.2947024915568194e+308":"(RH","e":2.3662647370926807e+307,"":"C"}
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/some/someGen/test836.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)