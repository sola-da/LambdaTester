...
base_0[2] = 7.775984727109039e+307
return a-b/c
};
var argument2 = true;
var argument3 = -100;
...
base_1[7] = 1.6343981197980917e+308
return a+b-c
};
var argument5 = null;
var argument6 = 460;
...
callbackArguments.push(JSON.stringify(arguments))
base_2[0] = true
base_2[6] = 6.114071666961194e+306
base_2[5] = [607]
return a+b/c
};
var argument8 = r_0;
...
callbackArguments.push(JSON.stringify(arguments))
base_3[1] = null
argument10[3.3156198695370476e+307] = ["U4","<oMkafkn","&",">",59,"I"]
base_3 = false
return a-b-c
};
var argument10 = 122;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/every/everyGen/test45.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)