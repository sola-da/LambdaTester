...
callbackArguments.push(JSON.stringify(arguments))
base_1[5] = "S"
base_1[2][7] = {"4.414534944079213e+307":"p"}
return a-b+c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/every/everyGen/test274.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)