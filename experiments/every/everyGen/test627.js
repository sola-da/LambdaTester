...
callbackArguments.push(JSON.stringify(arguments))
base_3[7] = 7.96837700975818e+307
return a+b*c
};
var argument8 = r_1;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/every/everyGen/test627.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)