...
callbackArguments.push(JSON.stringify(arguments))
argument6[5] = 823
argument5[6.447566193969e+307] = false
argument6[1] = true
return a+b/c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/every/everyGen/test997.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)