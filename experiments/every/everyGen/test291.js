...
argument2[403] = 2.711679715768121e+307
return a/b/c
};
var argument2 = function callback(a,b,c) { 
callbackArguments.push(JSON.stringify(arguments))
argument3[403] = ""
argument3[403] = {"25":4.236981740794979e+307,"783":"M","3.0754817000675394e+307":"","o6":5.132399240330538e+307,"zy":969,"":595}
return a*b/c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/every/everyGen/test291.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)