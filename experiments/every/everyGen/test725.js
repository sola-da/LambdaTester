...
callbackArguments.push(JSON.stringify(arguments))
argument5[122] = null
argument4[1] = 1.7609718677445298e+308
return a+b*c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/every/everyGen/test725.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)