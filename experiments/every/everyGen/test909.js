...
callbackArguments.push(JSON.stringify(arguments))
base_1[1][6] = [460,607,213,783,607,783]
argument6[5] = "q"
return a-b+c
};
...
callbackArguments.push(JSON.stringify(arguments))
base_2[5][2] = {"7":"g-64D","823":7.139518808789557e+307,"":1.1167787557308546e+308,"6.176753613729395e+307":"5","nFt":1.3713951224242728e+308}
return a*b+c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/every/everyGen/test909.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)