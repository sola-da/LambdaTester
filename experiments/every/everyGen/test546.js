...
argument2[1.3599216339661573e+308] = [655,122,25,49,0]
base_0[0][2] = 3.0102651880485557e+307
return a*b/c
};
var argument2 = function callback(a,b,c) { 
callbackArguments.push(JSON.stringify(arguments))
base_1[1][2] = 5.129643938065258e+307
return a+b+c
};
...
callbackArguments.push(JSON.stringify(arguments))
argument5[0] = {"kYj":1.7976931348623157e+308,"1.2712901005585418e+308":-100}
argument5[6] = false
base_3[1] = null
return a/b+c
};
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/every/everyGen/test546.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)