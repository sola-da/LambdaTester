...
var argument4 = function() {
 callbackArguments.push(arguments) 
 return [0,true,null,-6.168393953147357]; };
var argument5 = 705;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/every/everyQC/test419.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)