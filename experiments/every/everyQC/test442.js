...
var argument6 = function() {
 callbackArguments.push(arguments) 
 return [-0.06758601818799082,true,null,-6.285972997607314,"<Ã",null,1,false]; };
var argument7 = r_0;
var argument8 = false;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/every/everyQC/test442.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)