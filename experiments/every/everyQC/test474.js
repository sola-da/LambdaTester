...
var argument5 = function() {
 callbackArguments.push(arguments) 
 return {"äÿkÊ":0,"°Ã·j":-0.6088356698323443,"Åò¡ÐJ\u0001":false,"á fc":false,"a¹³¹":19,"<ô!>Ï":false}; };
var argument6 = r_2;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/every/everyQC/test474.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)