...
var argument1 = function() {
 ...
 return {"X1]":[],"=ì+ZÄ":false,"xdÐ\bµÎá":-6.2436486815572785,"Z":"[7[¶","\bb":6,"Ô§®¶hº³ W":63,"¤ìâ":21}; };
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/every/everyQC/test731.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)