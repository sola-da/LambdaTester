...
var argument3 = function() {
 callbackArguments.push(arguments) 
 return [null,false,true,false,false,2,-23]; };
var argument4 = true;
var argument5 = null;
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/every/everyQC/test800.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)