...
var argument9 = function() {
 callbackArguments.push(arguments) 
 return [0,0.4430220347324558,true,[],"¿",true,[0,false],9.680779744945815]; };
...
setTimeout(function(){
require("fs").writeFileSync("./experiments/every/everyQC/test359.json",JSON.stringify({"baseObjects":serialize([base_0,base_1,base_2,base_3]),"returnObjects":serialize([r_0,r_1,r_2,r_3]),"callbackArgs":callbackArguments}))
},300)